...
namespace AdventOfCode2017.Day08
{
    public static class Part1
    {
        public static void Run()
        {
            ...
            int faultymProgramWeight = FindLargestRegisterValue(data);
            Console.WriteLine("The largest value in the registers is: " + faultymProgramWeight);
            Utils.ExitKey.ExitAppIfEsc();
        }

        private static int FindLargestRegisterValue(string[] data)
        {
            ...
            // Find the highest register value and return it
            return registers.Max(o => o.Value);
        }
